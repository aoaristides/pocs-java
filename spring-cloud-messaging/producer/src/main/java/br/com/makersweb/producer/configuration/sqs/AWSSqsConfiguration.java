package br.com.makersweb.producer.configuration.sqs;
...
public class AWSSqsConfiguration {
    ...
    public AmazonSQSAsync amazonSQSAsync(final AwsClientBuilder.EndpointConfiguration endpointConfiguration) {
        ...
        /*
         * Criando uma fila com o nome especificado na variavel cloud.aws.queue.name do arquivo de propriedades
         * no localstack
         */
        sqsAsync.createQueue(configuration.getQueueName());
